...
public class BoatRunner extends Boat{
    ...
    public static void main(String[] args) {
        ...
        Coordinates e = w.getAdjacentLocation(new Coordinates(0,0), 3);

        BoatRunner[] brray = new BoatRunner[2];
        brray[0] = new BoatRunner(1, new Coordinates(3,3), 2, 9, 5, 6);
        brray[1] = new BoatRunner(1, new Coordinates(2,2), 2, 9, 5, 6);
        String map1 = w.drawTeamMap(brray, 2);
